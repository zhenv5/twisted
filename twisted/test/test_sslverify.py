...
try:
    ...
    try:
        c = SSL.Context(SSL.SSLv23_METHOD)
        c.set_alpn_select_callback(lambda c: None)
    except AttributeError:
...
class ALPNOnlyOptions(sslverify.OpenSSLCertificateOptions):
    ...
    def getContext(self):
        ...
        advertise no protocols, and override the select callback to select no
        protocols in case NPN was advertised.
        """
...
class NPNOnlyOptions(sslverify.OpenSSLCertificateOptions):
    ...
    def getContext(self):
        ...
        There are two things to do here: advertise no protocols, and override
        the select callback to select no protocols in case ALPN was advertised.
        """
